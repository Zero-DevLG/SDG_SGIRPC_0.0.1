...
<body >
    <div id="main_data_view">
        
        <div id="cabezera">
            <img src="../img/logo_2022.jpg">
        </div>
    ...
    <?php }else { ?>
        ...
        <a class="item-list" href="#"><img src="../img/iconos/close.png" id="close_doc_turn" title="cerrar" alt=""></a>
        <div id="content-icons">
            <ul id="list_item">
                
                <li> 
                    <a class="item-list" href="#"><img src="../img/iconos/editar2.png" title="Editar turno" id="edt_turn"
                    alt="<?php echo $estatus; ?>"></a>
                </li>
                <li>   
                <a class="item-list" href="../pdf2.php" target="blank"><img src="../img/iconos/pdf2.png" id="gen_pdf" title="Generar volante" alt=""></a>
                </li>
                <!-- <li> <a class="item-list" href="#"><img id="history" src="../img/iconos/history.png" title="Historial"></a></li> -->
                <li> 
                <a class="item-list" href="#"><img id="response" src="../img/iconos/response2.png" title="Ver respuesta"></a></li>
                <li> 
                <a class="item-list" href="#"><img id="gen_bis" src="../img/iconos/BIS2.png" title="Generar BIS"></a></li>
                <li>
                <a class="item-list" href="#"><img id="rebuild_2" src="../img/iconos/return_doc.png" title="Volver a turnar"></a>
                </li>
            </ul>
        </div>
