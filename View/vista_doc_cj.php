...
<head>
    ...
    <script src="../js/controller-vista_doc_cj.js?v=<?php echo (rand()); ?>"></script>                   
</head>
...
<div class="main-content">      
    <div id="side-menu">
                <ul class="list-group">
                    <li class="list-group-item list-2" id="option-at-doc">  <img src="../img/iconos/at_doc.png" class="icon-s" alt=""> <div>Responder documento</div></li>
                </ul>          
    </div>
    ...
    <div id="id-document">
        <?php if($m == 1){ ?>
            ...
            <div id="s_id">
                <input type="text" class="form-control" id="id_documento" value="<?php echo $id_documento; ?>" disabled>
            </div>
