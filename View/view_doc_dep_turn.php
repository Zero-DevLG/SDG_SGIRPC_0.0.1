<?php
    ...
    //Obtenemos el id del documento general
     $sql = $pdo->prepare("SELECT id_documento FROM instruccion_direccion_p  WHERE id_instruccion_g = '$id_documento'");
     $sql->execute();
                            ...
                            <tbody>
                                ...
                                <?php for($i = 0; $i < sizeof($files);$i++){ ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo $files[$i]; ?>" download="<?php echo  $mostrar[$i]; ?>"><?php echo $files[$i]; ?></a>
                                    </tr>
                                    <?php } ?>
                            </tbody>
                        </table>         
