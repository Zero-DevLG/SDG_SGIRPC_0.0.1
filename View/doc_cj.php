...
if ($_SESSION['usuario'] == "") {
    ...
    $sql = $pdo->prepare("SELECT nombre_departamento  FROM departamentos WHERE id_departamento = '$id_cj'");
    $sql->execute();
    $nombre_dep = $sql->fetchColumn();
...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" href="../css/estilos_cj.css?v=<?php echo (rand()); ?> ">
    ...
    <script src="../js/tables_cj.js?v=<?php echo (rand()); ?>"></script>
    ...
    <div id="contenido_dinamico">
       <div id="view_data">
            <div id="iframeI-2" style="overflow-y: auto;">    
                <div id="title-dir">
                <h5><?php echo $direccion.'/'.$direccion_s .'/' . $nombre_dep; ?></h5>
                </div>
                <hr id="sep-main">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">  
                                <table id="doc_cj" style="cursor:pointer;" class="table table-sm table-borderedless table-hover">
                                    <thead>
                                        <tr>
                                            <th id="td-id">ID Documento</th>
                                            <th>N.Oficio</th>
                                            <th>Folio SP</th>
                        ...
                        <div class="tab-pane fade" id="doc_dep_at" role="tabpanel" aria-labelledby="contact-tab">
                            <table id="table_cj_at" style="cursor:pointer;" class="table table-sm table-borderedless table-hover">
                                        <thead>
                                            <th>id</th>
                                            <th>Folio SP</th>
