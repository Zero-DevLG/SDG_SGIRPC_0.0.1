<?php
    ...
    $id_instruccion_doc = $_POST['id-document'];
    $id_dir  = $_SESSION['id_direccion'];
   
    
    //Obtenemos el id del documento general
    $sql = $pdo->prepare("SELECT id_documento FROM instrucciones_direcciones WHERE id_instruccion = '$id_instruccion_doc'");
    $sql->execute();
    ...
    <div id="id-document">
        <?php if($m == 1){ ?>
            ...
            <div id="data-document" class="container-fluid">
                <div class="row">
                    <div class="col-md-1">
                        <input type="text" id="id_ins" class="form-control" value="<?php echo $id_instruccion_doc ?>" disabled>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="title" >Instruccion dirección general:</h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
